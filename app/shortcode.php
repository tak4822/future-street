...
function headingFunc( $atts,  $content = null ) {
    $html = "<div class='custom-heading'><div class='white-border'></div><h2 class='custom-heading-text'>" . $content . "</h2></div>";
    return $html;
}
add_shortcode('heading', __NAMESPACE__ . '\\headingFunc');

function subHead( $atts,  $content = null ) {
    $html = "<div class='sub-heading'><div class='deco deco-1'></div><div class='deco deco-2'></div><h3 class='custom-red-text'>" . $content . "</h3></div>";
    return $html;
}
add_shortcode('red', __NAMESPACE__ . '\\subHead');
